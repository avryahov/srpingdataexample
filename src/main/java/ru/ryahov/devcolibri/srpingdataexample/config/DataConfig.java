package ru.ryahov.devcolibri.srpingdataexample.config;
...
@ComponentScan("ru.ryahov.devcolibri.springdataexample")
@PropertySource("classpath:app.properties")
@EnableJpaRepositories("ru.ryahov.devcolibri.springdataexample.repository")
